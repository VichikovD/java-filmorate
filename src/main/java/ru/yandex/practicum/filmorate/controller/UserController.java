...
public class UserController {
    ...
    public List<Film> getUserRecommendations(@PathVariable int userId) {
        log.info("GET {}", "\"/users/" + userId + "/recommendations\"");
        List<Film> recommendationList = userService.getUserRecommendations(userId);
        log.debug(recommendationList.toString());
