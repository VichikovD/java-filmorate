...
class FilmorateApplicationTests {
    ...
    public void testGetMostPopularFilms() {
        Film film1 = filmDbStorage.createFilm(getFilm(0));
        Film film2 = filmDbStorage.createFilm(getFilm(0));
        ...
        filmDbStorage.addLike(film2, user);
        List<Film> likedFilmsToTop = filmDbStorage.getMostPopularFilms(10);
        Film film2WithLike = filmDbStorage.getFilmById(film2.getId()).get();
